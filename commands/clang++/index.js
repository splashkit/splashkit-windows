...
execute = function (argv, callback) {
  ...
  if (process.env.MSYSTEM == 'MINGW32') {
    ...
    var fs = require('fs');
    fs.createReadStream(`${home}/.splashkit/lib/win32/libfreetype-6.dll`, {fd: null} ).pipe(fs.createWriteStream('libfreetype-6.dll'));
    ...
    console.log("Can''t determine environment.")
  }
